...
contains
  ...
  real(c_float) function cos_from_sin_f32(sin, angle) result(cosine)
    use :: constants_f90, only: PI_F32, PI_TIMES_2_F32, PI_OVER_2_F32
    implicit none
  ...
  real(c_double) function cos_from_sin_f64(sin, angle) result(cosine)
    use :: constants_f90, only: PI_F64, PI_TIMES_2_F64, PI_OVER_2_F64
    implicit none
